<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="vpshop.Admin.AdminLogin" %>
        ...
        <div class="container">
            ...
            <div class="col-sm-6">
                <div class="panel panel-danger">
                    <div class="panel-heading"><b>ADMIN LOGIN</b></center></div><br/>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <asp:Button ID="btnLogin" CssClass="btn btn-success" runat="server" Text="Login" OnClick="btnLogin_Click" Width="80px" />
                                    <asp:Button ID="btnCancel" CssClass="btn btn-danger" runat="server" Text="Cancel" Width="82px" />
                                </div>
